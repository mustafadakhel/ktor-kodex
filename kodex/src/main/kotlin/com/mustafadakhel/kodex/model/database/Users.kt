...
internal object Users : UUIDTable() {
    ...
    public val phoneNumber: org.jetbrains.exposed.sql.Column<String?> = varchar("phone_number", 20).nullable().uniqueIndex()
    public val email: org.jetbrains.exposed.sql.Column<String?> = varchar("email", 255).nullable().uniqueIndex()
